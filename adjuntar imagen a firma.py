...
def enviar_con_destinatario(servicio, destinatario, asunto, cuerpo_html, imagen_path):
...
def generar_contenido_html():
    ...
    <p><a href="img.png" style="color: green;">www.tusitio.com</a></p>
    """
...
def main():
    ...
    # Enviar el correo
    enviar_con_destinatario(servicio, destinatario, asunto, cuerpo_html_con_firma, imagen_path)
