...
def enviar_con_destinatario(servicio, destinatario, asunto, cuerpo_html, imagen_path, archivo_path, nombre_de):
    # Crear un mensaje MIME
    mensaje = MIMEMultipart()
    mensaje['From'] = f'{nombre_de} <ptorresc@fcchc.cl>'  # Cambiar el nombre aquí
...
def generar_contenido_html():
    cuerpo_html = """
    <p style="color: blue; font-weight: bold;">Correo de prueba FCChC, letra azul</p>
    <p style="font-size: 18px;">Prueba <strong>negrita</strong>, <span style="color: red;">colores</span>, y <em>cursiva</em>.</p>
    <p>Imagen FCChC:</p>
...
def main():
    ...
    destinatario = "jdelgado@fcchc.cl"
    asunto = "Correo de prueba, envio py con archivos adjuntos"
    ...
    nombre_de = "Patricio Torres"  # Nombre que aparecerá en el campo "De"

    # Enviar el correo
    enviar_con_destinatario(servicio, destinatario, asunto, cuerpo_html_con_firma, imagen_path, archivo_path, nombre_de)
